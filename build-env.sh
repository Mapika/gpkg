#!/bin/bash
# gpkg-build — compile CUDA extensions at full speed
#
# Usage:
#   source <(curl -LsSf https://raw.githubusercontent.com/Mapika/gpkg/main/build-env.sh)
